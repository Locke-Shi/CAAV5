...
CATImplementClass( ExcelClass,
                   Implementation, 
                   CATBaseUnknown,
                   CATNull );
 
//-----------------------------------------------------------------------------
// ExcelClass : constructor
//-----------------------------------------------------------------------------
ExcelClass::ExcelClass(/*CATUnicodeString fileFullPath*/):
    CATBaseUnknown()
{
	//CoInitialize(NULL);
...
//-----------------------------------------------------------------------------
// ExcelClass : copy constructor
//-----------------------------------------------------------------------------
ExcelClass::ExcelClass(ExcelClass& original):
   CATBaseUnknown(original)
{
}
 
//-----------------------------------------------------------------------------
// ExcelClass : equal operator
//-----------------------------------------------------------------------------
ExcelClass& ExcelClass::operator=(ExcelClass& original)
{
...
/*     	创建Excel文件
			sExcelFile:	Excel文件名                                                                 */
/************************************************************************/
CATBoolean ExcelClass::CreateExcel()
{
...
/*  //打开Excel文件                                                                    */
/************************************************************************/
CATBoolean ExcelClass::OpenExcel(CATUnicodeString ExcelPath)
{
	//判断文件是否存在
...
/*  	创建表
		sSheetName:	表名                                                                    */
/************************************************************************/
void ExcelClass::CreateSheet(CATUnicodeString sSheetName)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
...
*/
/************************************************************************/
void ExcelClass::RunMacro(CATUnicodeString strMacroName)
{
...
/* 设置sheet表名                                                                     */
/************************************************************************/
void ExcelClass::SetSheetName(int index,CATUnicodeString strName)
{
...
/*//得到sheet表名称*/
/************************************************************************/
CATUnicodeString ExcelClass::GetSheetName(int index)
{
...
/* 得到某一个sheet的索引                                                                     */
/************************************************************************/
int ExcelClass::GetSheetIndex(CATUnicodeString strSheetName)
{
	int index;
...
*/
/************************************************************************/
void ExcelClass::MoveSheetToPos(int SheetIndex,int MoveToPos)
{
...
/* 设置sheet为当前sheet                                                                     */
/************************************************************************/
void ExcelClass::SetCurrentSheet(CATUnicodeString strSheetName)
{
	int icount = GetSheetCount();
	for (int i = 1;i<=icount;i++)
	{
...
/*  写某一个sheet的某些单元格                                                              */
/************************************************************************/
void ExcelClass::WriteSheetCellsData(int sheetIndex,long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
*/
/************************************************************************/
void ExcelClass::CopySheet(int sheetIndex)
{
 	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
 	m_ExlSheet.Activate();
...
/* Delete sheet 
/************************************************************************/
void ExcelClass::DeleteSheet(int sheetIndex)
{
	m_ExlApp.SetDisplayAlerts(FALSE);
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/*        设置某个sheet的某些单元格黑线框                                                              */
/************************************************************************/
void ExcelClass::SetSheetCellBorderAround(int sheetIndex,long iStartRow,long iStartCol,long iEndRow,long iEndCol)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/* 修改某一个sheet表的某个单元格的值
*/
void ExcelClass::UpdateSheetCellData(int sheetIndex,long iRowIndex, long iColIndex, CATUnicodeString Value)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/* 得到某一个sheet的某一个单元格的值                                                                     */
/************************************************************************/
CATUnicodeString ExcelClass::GetSheetCellData(int sheetIndex,long iRowIndex, long iColIndex)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/************************************************************************/
void ExcelClass::WriteRowData(long iRow, long iColIndex, CATListOfCATUnicodeString &LstValue)
{
	Range sRange;
...
/************************************************************************/
void ExcelClass::WriteColData(long iRowIndex, long iCol, CATListOfCATUnicodeString &LstValue)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	int iValNum=LstValue.Size();
	int  k = 1;
...
/************************************************************************/
void ExcelClass::WriteData(long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	//一行一行的写入
	if (Type == 1)
...
/*  写某一个单元格的值                                                                    */
/************************************************************************/
void ExcelClass::WriteCellData(long iRowIndex, long iColIndex, CATUnicodeString Value)
{
...
/* 设置使用过的单元格黑线框                                                                     */
/************************************************************************/
void ExcelClass::SetCellBorderAround(long iStartRow,long iStartCol,long iEndRow,long iEndCol)
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/* 获得已经使用的行数的起始行                                                                     */
/************************************************************************/
int ExcelClass::GetUsedRowStart()
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/*     获得已经使用的列数的起始列                                                                  */
/************************************************************************/
int ExcelClass::GetUsedColStart()
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/* 读某一个单元格的值                                                                     */
/************************************************************************/
CATUnicodeString ExcelClass::ReadOneCellValue(long iRow,long iCol)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	Range   oCurCell;
...
/* 从某一行某一列读取此行的N列值                                                            */
/************************************************************************/
void ExcelClass::ReadRowData(long iRow,long iColIndex,long iColNum,CATListOfCATUnicodeString &oLstValue)
{
...
//得到某个sheet的某些单元格的值
void ExcelClass::GetSheetCellsData(int sheetIndex,long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/*  从某一行某一列读取此列的N行值                                                                    */
/************************************************************************/
//void ExcelClass::ReadColData(long iRowIndex,long iRowNum,long iCol,CATListOfCATUnicodeString &oLstValue)
void ExcelClass::ReadColData(long iCol, long iRowIndex,long iRowNum,CATListOfCATUnicodeString &oLstValue)
{
...
*/
/************************************************************************/
void ExcelClass::SetCellFontColor(long iRow,long iCol,COLORREF color)
{
	Font font;
...
/* 设置某一行的颜色                                                                     */
/************************************************************************/
void ExcelClass::SetRowFontColor(long iRow,COLORREF color)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
...
/* 设置某一列的颜色                                                                     */
/************************************************************************/
void ExcelClass::SetColFontColor(long iCol,COLORREF color)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
...
/* 设置某个单元格的字体大小                                                                     */
/************************************************************************/
void ExcelClass::SetCellFontSize(long iRow,long iCol,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某行字体大小                                                                     */
/************************************************************************/
void ExcelClass::SetRowFontSize(long iRow,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
...
/* 设置某列的字体大小                                                                     */
/************************************************************************/
void ExcelClass::SetColFontSize(long iCol,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某个单元格的字体是否为粗体                                                                     */
/************************************************************************/
void ExcelClass::SetCellFontBold(long iRow,long iCol,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某行的字体是否为粗体                                                                     */
/************************************************************************/
void ExcelClass::SetRowFontBold(long iRow,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
...
/* 设置某列的字体是否为粗体                                                                     */
/************************************************************************/
void ExcelClass::SetColFontBold(long iCol,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
...
*/
/************************************************************************/
void ExcelClass::SetHCellAlignStye(long iRow,long iCol,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
	//m_ExlRge.Select();
...
/* 设置某行的水平对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetHRowAlignStye(long iRow,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
	//m_ExlRge.Select();
...
/* 设置某列的水平对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetHColAlignStye(long iCol,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetHorizontalAlignment(_variant_t(hResult));
...
/* 设置某列的某些单元格水平对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetHColCellsAlignStye(long iCol,long iStartRow,long iEndRow,long hResult)
{
...
/* 设置某列的某些单元格垂直对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetVColCellsAlignStye(long iCol,long iStartRow,long iEndRow,long vResult)
{
	CString strStart;strStart.Format(_T("%c%d"),'A' + iCol -1,iStartRow);
	CString strEnd;strEnd.Format(_T("%c%d"),'A' + iCol -1,iEndRow);
	CString strT = strStart + ":" + strEnd;
...
/************************************************************************/
void ExcelClass::SetRangeFormatLocal(long iStartRow,long iStartCol,long iEndRow,long iEndCol,CATUnicodeString DecimalDigits)
{
...
/* 设置某个sheet 某些单元格格式                                                               */
/************************************************************************/
void ExcelClass::SetSheetRangeFormat(int sheetIndex,long iStartRow,long iStartCol,long iEndRow,long iEndCol,CATUnicodeString DecimalDigits)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
*/
/************************************************************************/
void ExcelClass::SetVCellAlignStye(long iRow,long iCol,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某行的垂直对齐方式                                                                     */
/************************************************************************/
void ExcelClass::SetVRowAlignStye(long iRow,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某列的垂直对齐方式                                                                     */
/************************************************************************/
void ExcelClass::SetVColAlignStye(long iCol,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某行的某些单元格水平对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetHRowCellsAlignStye(long iRow,long iStartCol,long iEndCol,long hResult)
{
...
/* 设置某行的某些单元格垂直对齐格式                                                                     */
/************************************************************************/
void ExcelClass::SetVRowCellsAlignStye(long iRow,long iStartCol,long iEndCol,long vResult)
{
	CString strStart;strStart.Format(_T("%c%d"),'A' + iStartCol -1,iRow);
	CString strEnd;strEnd.Format(_T("%c%d"),'A' + iEndCol -1,iRow);
	CString strT = strStart + ":" + strEnd;
...
/* 合并单元格                                                                     */
/************************************************************************/
//void ExcelClass::MergeCells(long iRowStart,long iColStart,long iRowEnd,long iColEnd)
//{
...
//MergeCells()
//-------------------------------------------------------------------------
void ExcelClass::MergeCell(CString iRowStart,CString iColStart,CString iRowEnd,CString iColEnd)
{
	//行号转变数字字符串 
...
// /* 增加行 当前行向下移动*/
// /************************************************************************/
 void ExcelClass::InsertRows(long iRow)
 {
 	Range tRange;
...
// /* 增加列 当前列向后移动*/
// /************************************************************************/
 void ExcelClass::InsertCols(long iCol)
 {
 	Range tRange;
...
/* 写公式*/
/************************************************************************/
void ExcelClass::WriteFormula(long iRow,long iCol,CATUnicodeString formula )
{
	Range tRange;
...
*/
/************************************************************************/
void ExcelClass::SetColWidth(long iColumn, float iWidth)
{
	Range tRange;
...
*/
/************************************************************************/
void ExcelClass::SetRowHeight(long iRow, float iHeight)
{
	Range tRange;
...
*/
/************************************************************************/
void ExcelClass::GetColWidth(long iColumn, float &iWidth)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(vtMissing, _variant_t(iColumn)).pdispVal, true);
	//得到列宽
...
*/
/************************************************************************/
void ExcelClass::GetRowHeight(long iRow, float &iHeight)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(_variant_t(iRow),vtMissing).pdispVal, true);
	//得到行高
...
/* 设置单元格的宽高值                                                                     */
/************************************************************************/
void ExcelClass::SetCellHeightWidth(long iRow,long iCol,float iHeight,float iWidth)
{
	Range tRange;
...
/* 设置自动换行                                                                     */
/************************************************************************/
void ExcelClass::SetAutoWrap(long iRow, long iColumn)
{
	Range tRange;
...
/************************************************************************/
void ExcelClass::AllCellAutoFit(int Fillstye)
{
	//选择所有列
	Range range;
...
*/
/************************************************************************/
//void ExcelClass::SetBorders(long iStartRow, long iStartColumn, long iEndRow, long iEndColumn,// 指定的单元格
...
void ExcelClass::SetBorders(long iStartRow, long iStartColumn, long iEndRow, long iEndColumn)
{
...
*/
/************************************************************************/
void ExcelClass::CreatChartObjects(double dLeft, double dTop, double dWidth, double dHeight, // 图标的位置和大小
...
/* 冻结行                                                                     */
/************************************************************************/
void ExcelClass::LineFreezePanes(long iRow)
{
	CString str = "A";
...
*/
/************************************************************************/
void ExcelClass::SetRowFillColor(long iRow,COLORREF color)
{
	CString str = "A";
	CString strN;strN.Format(_T("%d"),iRow);
	CString strT = str + strN;
...
*/
/************************************************************************/
void ExcelClass::SetColFillColor(long iCol,COLORREF color)
{
	iCol += 'A' - 1;
...
*/
/************************************************************************/
void ExcelClass::SetRangeFillColor(long iRow,long iCol,COLORREF color)
{
	iCol += 'A' - 1;
...
*/
/************************************************************************/
void ExcelClass::SetSomeRangeFillColor(long iStartRow,long iStartCol,long iEndRow,long iEndCol,COLORREF color)
{
	iStartCol += 'A' - 1;
	iEndCol += 'A' - 1;
...
*/
/************************************************************************/
void ExcelClass::InsertPictures(long iRow,long iCol,float iRowHeight,float iColWidth,CATUnicodeString iPicturePath, float iRowOffSet, float iColOffSet)
{
	iCol += 'A' - 1;
...
/*读取合并的单元格信息                                                                      */
/************************************************************************/
void ExcelClass::GetMergeAreaInfo(long iRow, long iColumn, long& MergeRowCount, long& MergeColumnCount, long& MergeStartRow, long& MergeStartColumn)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(_variant_t((long)iRow), _variant_t((long)(iColumn))).pdispVal, true);
...
///* 删除列                                                                     */
///************************************************************************/
void ExcelClass::DeleteCol(long iCol)
{
	Range tRange;
...
///* 删除行                                                                     */
///************************************************************************/
void ExcelClass::DeleteRow(long iRow)
{
	/*Range tRange;
	tRange.AttachDispatch(m_ExlSheet.GetCells());
...
/* 保存                                                                 */
/************************************************************************/
void ExcelClass::SaveExcelFile(CString savePath,bool bOpenTemp)
{
	if (bOpenTemp)
	{
...
/* 关闭                                                                */
/************************************************************************/
void ExcelClass::CloseExcelFile(CString savePath)
{
	//m_ExlBook.SetSaved(TRUE);
	//m_ExlBook.Close(covOptional, COleVariant(savePath), covOptional);
	m_ExlBooks.Close();
...
/* 保存为文本                                                                 */
/************************************************************************/
void ExcelClass::SaveTextFile(CString savePath,bool bOpenTemp)
{
	if (bOpenTemp)
	{
		m_ExlBook.SaveAs(COleVariant(savePath),
...
//下载单元格图片到本地路径
//-------------------------------------------------------------------------
void ExcelClass::DownloadPicuture( int iSheetIndex, int iRow, int iCol, CATUnicodeString istrFileSavePath )
{
	//获取指定单元格
