...
public:
	...
	VARIANT Delete(const VARIANT& ShiftRangeDel);
	...
	VARIANT Insert(const VARIANT& ShiftInsert, const VARIANT& CopyOrigin);
...
public:
	...
	void Deactivate();
	void Resize();
//	void MouseDown(long iButton, long Shift, long x, long y);
