...
//-----------------------------------------------------------------------------
// MD5 : copy constructor
//-----------------------------------------------------------------------------
MD5::MD5(MD5& original):
...
int MD5::_httoi(const char *value)
{
	struct CHexMap
	{
		char chr;
...
char* MD5::ToString()
{
	...
	cout << "MD5::ToString()---output1=" <<output1<< endl;
