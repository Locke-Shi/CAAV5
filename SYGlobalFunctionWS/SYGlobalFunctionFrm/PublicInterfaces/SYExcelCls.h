...
* <p>
* Do not use the @href SYExcelCls constructor to
* do such and such but instead...
*
* @example
*  // example is optional
*  pObject = new SYExcelCls;
*  pObject->SetXXX(...);
*
* @href ClassReference, Class#MethodReference, #InternalMethod...
*/
class SYExcelCls: public CATBaseUnknown
{
	CATDeclareClass;
...
public:
	...
	// -------------------------------------
	SYExcelCls (/*CATUnicodeString fileFullPath*/);
	virtual ~SYExcelCls ();

	// Copy constructor and equal operator
	// -----------------------------------
	SYExcelCls (SYExcelCls &);
	SYExcelCls& operator=(SYExcelCls&);
...
public:
	...
	//得到某一个sheet使用的行数
	int GetSheetUsedRows(int sheetIndex);
	//得到某一个sheet使用的列数
	int GetSheetUsedCols(int sheetIndex);
	//设置某一个sheet表的某个单元格的值
