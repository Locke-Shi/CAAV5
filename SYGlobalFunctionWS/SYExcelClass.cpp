...
//
// SYExcelClass.cpp
// Header definition of SYExcelClass
//
//===================================================================
//
// Usage notes:
...
//===================================================================
#include "SYExcelClass.h"



COleVariant covOptional((long)DISP_E_PARAMNOTFOUND, VT_ERROR); 
 
CATImplementClass( SYExcelClass,
                   Implementation, 
                   CATBaseUnknown,
                   CATNull );
 
//-----------------------------------------------------------------------------
// SYExcelClass : constructor
//-----------------------------------------------------------------------------
SYExcelClass::SYExcelClass(/*CATUnicodeString fileFullPath*/):
    CATBaseUnknown()
{
	CoInitialize(NULL);
...
//-----------------------------------------------------------------------------
// SYExcelClass : destructor
//-----------------------------------------------------------------------------
SYExcelClass::~SYExcelClass()
{
...
//-----------------------------------------------------------------------------
// SYExcelClass : copy constructor
//-----------------------------------------------------------------------------
SYExcelClass::SYExcelClass(SYExcelClass& original):
   CATBaseUnknown(original)
{
}
 
//-----------------------------------------------------------------------------
// SYExcelClass : equal operator
//-----------------------------------------------------------------------------
SYExcelClass& SYExcelClass::operator=(SYExcelClass& original)
{
...
/*     	创建Excel文件
			sExcelFile:	Excel文件名                                                                 */
/************************************************************************/
CATBoolean SYExcelClass::CreateExcel()
{
...
/*  //打开Excel文件                                                                    */
/************************************************************************/
CATBoolean SYExcelClass::OpenExcel(CATUnicodeString ExcelPath)
{
	//判断文件是否存在
...
/*  	创建表
		sSheetName:	表名                                                                    */
/************************************************************************/
void SYExcelClass::CreateSheet(CATUnicodeString sSheetName)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
...
*/
/************************************************************************/
void SYExcelClass::RunMacro(CATUnicodeString strMacroName)
{
...
/* 设置sheet表名                                                                     */
/************************************************************************/
void SYExcelClass::SetSheetName(int index,CATUnicodeString strName)
{
...
/*//得到sheet表名称*/
/************************************************************************/
CATUnicodeString SYExcelClass::GetSheetName(int index)
{
...
/* 得到某一个sheet的索引                                                                     */
/************************************************************************/
int SYExcelClass::GetSheetIndex(CATUnicodeString strSheetName)
{
	int index;
...
*/
/************************************************************************/
void SYExcelClass::MoveSheetToPos(int SheetIndex,int MoveToPos)
{
...
/* 设置sheet为当前sheet                                                                     */
/************************************************************************/
void SYExcelClass::SetCurrentSheet(CATUnicodeString strSheetName)
{
	int icount = GetSheetCount();
	for (int i = 1;i<=icount;i++)
	{
...
/*  写某一个sheet的某些单元格                                                              */
/************************************************************************/
void SYExcelClass::WriteSheetCellsData(int sheetIndex,long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
*/
/************************************************************************/
void SYExcelClass::CopySheet(int sheetIndex)
{
 	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
 	m_ExlSheet.Activate();
...
/* Delete sheet 
/************************************************************************/
void SYExcelClass::DeleteSheet(int sheetIndex)
{
	m_ExlApp.SetDisplayAlerts(FALSE);
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/*        设置某个sheet的某些单元格黑线框                                                              */
/************************************************************************/
void SYExcelClass::SetSheetCellBorderAround(int sheetIndex,long iStartRow,long iStartCol,long iEndRow,long iEndCol)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/* 得到某个sheet已经使用的行数
*/
int SYExcelClass::GetSheetUsedRows(int sheetIndex)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/* 得到某个sheet已经使用的列数
*/
int SYExcelClass::GetSheetUsedCols(int sheetIndex)
{
	//m_ExlSheets.AttachDispatch(m_ExlBook.GetWorksheets(),true);
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
*/
int SYExcelClass::GetSheetCount()
{
	//得到Worksheets 
	m_ExlSheets.AttachDispatch(m_ExlBook.GetWorksheets(),true);
...
/* 修改某一个sheet表的某个单元格的值
*/
void SYExcelClass::UpdateSheetCellData(int sheetIndex,long iRowIndex, long iColIndex, CATUnicodeString Value)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/* 得到某一个sheet的某一个单元格的值                                                                     */
/************************************************************************/
CATUnicodeString SYExcelClass::GetSheetCellData(int sheetIndex,long iRowIndex, long iColIndex)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/************************************************************************/
void SYExcelClass::WriteRowData(long iRow, long iColIndex, CATListOfCATUnicodeString &LstValue)
{
	Range sRange;
...
/************************************************************************/
void SYExcelClass::WriteColData(long iRowIndex, long iCol, CATListOfCATUnicodeString &LstValue)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	int iValNum=LstValue.Size();
	int  k = 1;
...
/************************************************************************/
void SYExcelClass::WriteData(long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	//一行一行的写入
	if (Type == 1)
...
/*  写某一个单元格的值                                                                    */
/************************************************************************/
void SYExcelClass::WriteCellData(long iRowIndex, long iColIndex, CATUnicodeString Value)
{
...
/* 获得已经使用的行数                                                                     */
/************************************************************************/
int SYExcelClass::GetUsedRowNum()
{
	Range usedRange;
...
/* 设置使用过的单元格黑线框                                                                     */
/************************************************************************/
void SYExcelClass::SetCellBorderAround(long iStartRow,long iStartCol,long iEndRow,long iEndCol)
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/* 获得已经使用的列数                                                                     */
/************************************************************************/
int SYExcelClass::GetUsedColNum()
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/* 获得已经使用的行数的起始行                                                                     */
/************************************************************************/
int SYExcelClass::GetUsedRowStart()
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/*     获得已经使用的列数的起始列                                                                  */
/************************************************************************/
int SYExcelClass::GetUsedColStart()
{
	Range usedRange;
	usedRange.AttachDispatch(m_ExlSheet.GetUsedRange());
...
/* 读某一个单元格的值                                                                     */
/************************************************************************/
CATUnicodeString SYExcelClass::ReadOneCellValue(long iRow,long iCol)
{
	m_ExlRge.AttachDispatch( m_ExlSheet.GetCells(), TRUE ); 
	Range   oCurCell;
...
/* 从某一行某一列读取此行的N列值                                                            */
/************************************************************************/
void SYExcelClass::ReadRowData(long iRow,long iColIndex,long iColNum,CATListOfCATUnicodeString &oLstValue)
{
...
//得到某个sheet的某些单元格的值
void SYExcelClass::GetSheetCellsData(int sheetIndex,long iRowStart, long iColStart,long iRowEnd, long iColEnd, CATListOfCATUnicodeString &LstValue,int Type)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
/*  从某一行某一列读取此列的N行值                                                                    */
/************************************************************************/
//void SYExcelClass::ReadColData(long iRowIndex,long iRowNum,long iCol,CATListOfCATUnicodeString &oLstValue)
void SYExcelClass::ReadColData(long iCol, long iRowIndex,long iRowNum,CATListOfCATUnicodeString &oLstValue)
{
...
*/
/************************************************************************/
void SYExcelClass::SetCellFontColor(long iRow,long iCol,COLORREF color)
{
	Font font;
...
/* 设置某一行的颜色                                                                     */
/************************************************************************/
void SYExcelClass::SetRowFontColor(long iRow,COLORREF color)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
...
/* 设置某一列的颜色                                                                     */
/************************************************************************/
void SYExcelClass::SetColFontColor(long iCol,COLORREF color)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
...
/* 设置某个单元格的字体大小                                                                     */
/************************************************************************/
void SYExcelClass::SetCellFontSize(long iRow,long iCol,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某行字体大小                                                                     */
/************************************************************************/
void SYExcelClass::SetRowFontSize(long iRow,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
...
/* 设置某列的字体大小                                                                     */
/************************************************************************/
void SYExcelClass::SetColFontSize(long iCol,int iFontSize)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某个单元格的字体是否为粗体                                                                     */
/************************************************************************/
void SYExcelClass::SetCellFontBold(long iRow,long iCol,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
...
/* 设置某行的字体是否为粗体                                                                     */
/************************************************************************/
void SYExcelClass::SetRowFontBold(long iRow,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
...
/* 设置某列的字体是否为粗体                                                                     */
/************************************************************************/
void SYExcelClass::SetColFontBold(long iCol,bool bBold)
{
	Font font;
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
...
*/
/************************************************************************/
void SYExcelClass::SetHCellAlignStye(long iRow,long iCol,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
	//m_ExlRge.Select();
...
/* 设置某行的水平对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetHRowAlignStye(long iRow,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
	//m_ExlRge.Select();
...
/* 设置某列的水平对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetHColAlignStye(long iCol,long hResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetHorizontalAlignment(_variant_t(hResult));
...
/* 设置某列的某些单元格水平对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetHColCellsAlignStye(long iCol,long iStartRow,long iEndRow,long hResult)
{
...
/* 设置某列的某些单元格垂直对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetVColCellsAlignStye(long iCol,long iStartRow,long iEndRow,long vResult)
{
	CString strStart;strStart.Format(_T("%c%d"),'A' + iCol -1,iStartRow);
	CString strEnd;strEnd.Format(_T("%c%d"),'A' + iCol -1,iEndRow);
	CString strT = strStart + ":" + strEnd;
...
/************************************************************************/
void SYExcelClass::SetRangeFormatLocal(long iStartRow,long iStartCol,long iEndRow,long iEndCol,CATUnicodeString DecimalDigits)
{
...
/* 设置某个sheet 某些单元格格式                                                               */
/************************************************************************/
void SYExcelClass::SetSheetRangeFormat(int sheetIndex,long iStartRow,long iStartCol,long iEndRow,long iEndCol,CATUnicodeString DecimalDigits)
{
	m_ExlSheet.AttachDispatch(m_ExlSheets.GetItem(COleVariant((short)(sheetIndex))));
	m_ExlSheet.Activate();
...
*/
/************************************************************************/
void SYExcelClass::SetVCellAlignStye(long iRow,long iCol,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某行的垂直对齐方式                                                                     */
/************************************************************************/
void SYExcelClass::SetVRowAlignStye(long iRow,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (COleVariant(iRow), vtMissing)).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某列的垂直对齐方式                                                                     */
/************************************************************************/
void SYExcelClass::SetVColAlignStye(long iCol,long vResult)
{
	m_ExlRge.AttachDispatch(m_ExlSheet.GetCells());
	m_ExlRge.AttachDispatch((m_ExlRge.GetItem (vtMissing, COleVariant(iCol))).pdispVal,TRUE);
	m_ExlRge.SetVerticalAlignment(_variant_t(vResult));
...
/* 设置某行的某些单元格水平对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetHRowCellsAlignStye(long iRow,long iStartCol,long iEndCol,long hResult)
{
...
/* 设置某行的某些单元格垂直对齐格式                                                                     */
/************************************************************************/
void SYExcelClass::SetVRowCellsAlignStye(long iRow,long iStartCol,long iEndCol,long vResult)
{
	CString strStart;strStart.Format(_T("%c%d"),'A' + iStartCol -1,iRow);
	CString strEnd;strEnd.Format(_T("%c%d"),'A' + iEndCol -1,iRow);
	CString strT = strStart + ":" + strEnd;
...
/* 合并单元格                                                                     */
/************************************************************************/
//void SYExcelClass::MergeCells(long iRowStart,long iColStart,long iRowEnd,long iColEnd)
//{
...
//MergeCells()
//-------------------------------------------------------------------------
void SYExcelClass::MergeCell(CString iRowStart,CString iColStart,CString iRowEnd,CString iColEnd)
{
	//行号转变数字字符串 
...
// /* 增加行 当前行向下移动*/
// /************************************************************************/
 void SYExcelClass::InsertRows(long iRow)
 {
 	Range tRange;
...
// /* 增加列 当前列向后移动*/
// /************************************************************************/
 void SYExcelClass::InsertCols(long iCol)
 {
 	Range tRange;
...
/* 写公式*/
/************************************************************************/
void SYExcelClass::WriteFormula(long iRow,long iCol,CATUnicodeString formula )
{
	Range tRange;
...
*/
/************************************************************************/
void SYExcelClass::SetColWidth(long iColumn, float iWidth)
{
	Range tRange;
...
*/
/************************************************************************/
void SYExcelClass::SetRowHeight(long iRow, float iHeight)
{
	Range tRange;
...
*/
/************************************************************************/
void SYExcelClass::GetColWidth(long iColumn, float &iWidth)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(vtMissing, _variant_t(iColumn)).pdispVal, true);
	//得到列宽
...
*/
/************************************************************************/
void SYExcelClass::GetRowHeight(long iRow, float &iHeight)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(_variant_t(iRow),vtMissing).pdispVal, true);
	//得到行高
...
/* 设置单元格的宽高值                                                                     */
/************************************************************************/
void SYExcelClass::SetCellHeightWidth(long iRow,long iCol,float iHeight,float iWidth)
{
	Range tRange;
...
/* 设置自动换行                                                                     */
/************************************************************************/
void SYExcelClass::SetAutoWrap(long iRow, long iColumn)
{
	Range tRange;
...
/************************************************************************/
void SYExcelClass::AllCellAutoFit(int Fillstye)
{
	//选择所有列
	Range range;
...
*/
/************************************************************************/
//void SYExcelClass::SetBorders(long iStartRow, long iStartColumn, long iEndRow, long iEndColumn,// 指定的单元格
...
void SYExcelClass::SetBorders(long iStartRow, long iStartColumn, long iEndRow, long iEndColumn)
{
...
*/
/************************************************************************/
void SYExcelClass::CreatChartObjects(double dLeft, double dTop, double dWidth, double dHeight, // 图标的位置和大小
...
/* 冻结行                                                                     */
/************************************************************************/
void SYExcelClass::LineFreezePanes(long iRow)
{
	CString str = "A";
...
*/
/************************************************************************/
void SYExcelClass::SetRowFillColor(long iRow,COLORREF color)
{
	CString str = "A";
	CString strN;strN.Format(_T("%d"),iRow);
	CString strT = str + strN;
...
*/
/************************************************************************/
void SYExcelClass::SetColFillColor(long iCol,COLORREF color)
{
	iCol += 'A' - 1;
...
*/
/************************************************************************/
void SYExcelClass::SetRangeFillColor(long iRow,long iCol,COLORREF color)
{
	iCol += 'A' - 1;
...
*/
/************************************************************************/
void SYExcelClass::SetSomeRangeFillColor(long iStartRow,long iStartCol,long iEndRow,long iEndCol,COLORREF color)
{
	iStartCol += 'A' - 1;
	iEndCol += 'A' - 1;
...
*/
/************************************************************************/
void SYExcelClass::InsertPictures(long iRow,long iCol,float iRowHeight,float iColWidth,CATUnicodeString iPicturePath, float iRowOffSet, float iColOffSet)
{
	iCol += 'A' - 1;
...
/*读取合并的单元格信息                                                                      */
/************************************************************************/
void SYExcelClass::GetMergeAreaInfo(long iRow, long iColumn, long& MergeRowCount, long& MergeColumnCount, long& MergeStartRow, long& MergeStartColumn)
{
	Range tRange;
	tRange.AttachDispatch(m_ExlRge.GetItem(_variant_t((long)iRow), _variant_t((long)(iColumn))).pdispVal, true);
...
///* 删除列                                                                     */
///************************************************************************/
void SYExcelClass::DeleteCol(long iCol)
{
	Range tRange;
...
///* 删除行                                                                     */
///************************************************************************/
void SYExcelClass::DeleteRow(long iRow)
{
	/*Range tRange;
	tRange.AttachDispatch(m_ExlSheet.GetCells());
...
/* 保存                                                                 */
/************************************************************************/
void SYExcelClass::SaveExcelFile(CString savePath,bool bOpenTemp)
{
	if (bOpenTemp)
	{
...
/* 关闭                                                                */
/************************************************************************/
void SYExcelClass::CloseExcelFile(CString savePath)
{
	//m_ExlBook.SetSaved(TRUE);
	//m_ExlBook.Close(covOptional, COleVariant(savePath), covOptional);
	m_ExlBooks.Close();
...
/* 保存为文本                                                                 */
/************************************************************************/
void SYExcelClass::SaveTextFile(CString savePath,bool bOpenTemp)
{
	if (bOpenTemp)
	{
		m_ExlBook.SaveAs(COleVariant(savePath),
...
//下载单元格图片到本地路径
//-------------------------------------------------------------------------
void SYExcelClass::DownloadPicuture( int iSheetIndex, int iRow, int iCol, CATUnicodeString istrFileSavePath )
{
	//获取指定单元格
